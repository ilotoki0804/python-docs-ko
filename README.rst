Translation of the Python Documentation — ko
============================================

.. image:: https://travis-ci.org/python/python-docs-ko.svg?branch=3.12
  :target: https://travis-ci.org/python/python-docs-ko
...
- Or just by opening `an issue on github <https://github.com/python/python-docs-ko/issues>`_
...
You'll need to fork the `python-docs-ko
<https://github.com/python/python-docs-ko>`_ clicking its ``Fork``
...
.. code-block:: bash
    ...
    git clone git@github.com:JulienPalard/python-docs-ko.git

    # Go to the cloned directory:
    cd python-docs-ko/

    # Add the upstream (the public repository) using HTTPS (won't ask for password):
    git remote add upstream https://github.com/python/python-docs-ko.git
...
.. code-block:: bash
    ...
    # https://github.com/python/python-docs-ko/ and a nice "Compare & pull request"
...
All those snippets are to run from the root of a ``python-docs-ko``
